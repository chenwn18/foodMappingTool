...
class Config:
    def __init__(self):
        ...
        self.between_general_systems = os.path.join(self.json_tree_folder, 'IDsBetweenGeneral.json')
        self.chemisNodes = os.path.join(self.json_tree_folder, '化学.json')
        self.breakNodes = os.path.join(self.json_tree_folder, '暴发.json')
        self.microNodes = os.path.join(self.json_tree_folder, '微生物.json')
        self.chemisCode2SysID = os.path.join(self.json_tree_folder, '化学Code2SystemID.json')
        self.breakCode2SysID = os.path.join(self.json_tree_folder, '暴发Code2SystemID.json')
        self.microCode2SysID = os.path.join(self.json_tree_folder, '微生物Code2SystemID.json')
